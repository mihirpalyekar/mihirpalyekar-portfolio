...
import { NAME, DESIGNATION, SOCIAL_LINKS, PROFILE_URL } from '../../../constants/constants';
  ...
  return (
    <>
      ...
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <Image width={500} height={500} className='w-20 h-20 rounded-full object-cover' src={PROFILE_URL} alt='profile picture' />
      ...
      <div className='footer absolute flex justify-center space-x-6 text-xl items-center bottom-0 z-50 h-10 w-full bg-MidNightBlack text-Snow'>
        ...
        <Link href={SOCIAL_LINKS.LEETCODE} target='_blank' rel='noreferrer' className=''>
          <SiLeetcode />
        </Link>
        ...
        <Link href={SOCIAL_LINKS.UPWORK} target='_blank' rel='noreferrer' className=''>
          <SiUpwork />
        </Link>
      </div>
    </>
